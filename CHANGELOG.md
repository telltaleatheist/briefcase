...
All notable changes to the Briefcase project will be documented in this file.
...
- **Note**: Users can also delete `~/Library/Application Support/Briefcase/Briefcase.db` to recreate with fresh schema
