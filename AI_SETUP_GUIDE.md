...
Briefcase now features a comprehensive, user-friendly AI setup system that makes it clear that **AI features are completely optional**. Users can fully use the video library, player, and download features without any AI configuration.
...
**Key Message:**
> "You can use Briefcase's library, player, and download features without any AI setup. AI features (transcription and analysis) require additional setup but are **not required** to use the core functionality."
...
### First-Time User
1. Opens Briefcase for the first time
2. Sees "Welcome to Briefcase" dialog
...
### API Key Storage
- Stored in backend at `~/Library/Application Support/briefcase/api-keys.json`
...
The new AI setup system makes Briefcase approachable for all users, whether they're tech-savvy or complete beginners. By making AI optional and providing clear, step-by-step guidance, users can choose their preferred experience without feeling overwhelmed or forced into complex setup processes.
