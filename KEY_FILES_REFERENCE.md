...
- **Path**: `/Volumes/Callisto/Projects/briefcase/backend/src/database/database.service.ts`
- **Key Methods**:
...
**Database Location**: `~/Library/Application Support/briefcase/briefcase.db` (SQLite via sql.js)
...
- **Path**: `/Volumes/Callisto/Projects/briefcase/backend/src/analysis/analysis.service.ts`
- **Key Methods**:
...
**Output Location**: `~/Downloads/briefcase/analysis/`

### Batch Analysis Service (Multiple Videos + Database)
- **Path**: `/Volumes/Callisto/Projects/briefcase/backend/src/database/batch-analysis.service.ts`
- **Key Methods**:
...
- **Path**: `/Volumes/Callisto/Projects/briefcase/backend/src/analysis/analysis.controller.ts`
- **Key Endpoints**:
...
- **Path**: `/Volumes/Callisto/Projects/briefcase/backend/src/database/database.controller.ts`
- **Key Endpoints**:
...
- **Path**: `/Volumes/Callisto/Projects/briefcase/frontend/src/app/services/database-library.service.ts`
- **Key Methods**:
...
- **Path**: `/Volumes/Callisto/Projects/briefcase/frontend/src/app/components/video-analysis/video-analysis.component.ts`
- **Key Methods**:
...
- **Path**: `/Volumes/Callisto/Projects/briefcase/frontend/src/app/components/library/library.component.ts`
- **Key Methods**:
...
- **Path**: `/Volumes/Callisto/Projects/briefcase/frontend/src/app/components/library/analyze-selected-dialog.component.ts`
- **Options**:
...
**File**: `/Volumes/Callisto/Projects/briefcase/backend/src/database/batch-analysis.service.ts`
**Lines**: 437-444
...
**File**: `/Volumes/Callisto/Projects/briefcase/backend/src/analysis/analysis.controller.ts`
**Lines**: 224-228
...
### Database Location
`~/Library/Application Support/briefcase/briefcase.db`

### File System Output (Single Analysis)
`~/Downloads/briefcase/analysis/`
