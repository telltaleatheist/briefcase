 ...
 * little variety.
 */
export type AITaskKind = 'chapter' | 'flags' | 'tags' | 'description' | 'title';

/**
 * Sampling temperature per task (sent only to a Crucible catalog model and
 * `ollama/`; a cloud upstream gets none, crucible/llm/target.ts).
